...
INPUT_FILE = "results/qwen35_122b/final_results.csv"
...
def main():
    ...
    report_file = "results/qwen35_122b/122b_evaluation_report.txt"
    ...
    metrics.to_csv(
    "results/qwen35_122b/evaluation_metrics.csv",
    index=False
)

    print(f"\nSaved evaluation report to {report_file}")
    print("Saved metrics to results/qwen35_122b/evaluation_metrics.csv")
